...
<node TEXT="inside the current deck" ID="ID_630655937" CREATED="1406773347590" MODIFIED="1406773730161">
<icon BUILTIN="bookmark"/>
<node TEXT="check if it works with obstacles" ID="ID_512328704" CREATED="1406774784076" MODIFIED="1406774794055"/>
</node>
</node>
<node TEXT="movement" ID="ID_904829109" CREATED="1406772847313" MODIFIED="1406772849687">
<node TEXT="inside the current deck" ID="ID_1042424760" CREATED="1406772855058" MODIFIED="1406773727002">
<icon BUILTIN="bookmark"/>
<node TEXT="check if it works with obstacles" ID="ID_1080244316" CREATED="1406774784076" MODIFIED="1406774794055"/>
</node>
...
<icon BUILTIN="yes"/>
<node TEXT="change pathfinding map" ID="ID_863292424" CREATED="1406773790290" MODIFIED="1406774082083"/>
